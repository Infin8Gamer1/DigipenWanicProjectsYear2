...
public:
	...
	// Params:
	//   key	= The key to set.
	//   isDown	= Whether the key is down.
	//	 resetPrevious = Whether to set the value for the previous frame to false.
	void SetKeyDown(unsigned key, bool isDown, bool resetPrevious = false);
