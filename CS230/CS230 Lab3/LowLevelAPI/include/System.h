...
public:
	...
	//   show = Whether to show the window upon creation.
	void Initialize(HINSTANCE instance, unsigned screenWidth = 800, 
		unsigned screenHeight = 600, unsigned framerateCap = 200, bool show = true);
	...
	// Sets the title of the window being used by Alpha Engine.
	// Params: 
...
private:
	...
	// This struct is used by Alpha Engine to initialize the internal systems.
	...
	// Initializes the Alpha Engine Systems. Uses the specified options to initialize Beta Engine and
	// the functionality handled by Beta Engine.
	// Params: 
	//   instance = Handle to the application instance.
	//   screenWidth = Width of the window in pixels.
	//   screenHeight = Height of the window in pixels.
	//   framerateCap = Maximum framerate.
	//   show = Whether to show the window upon creation.
	void InitHelper(HINSTANCE instance, unsigned screenWidth, unsigned screenHeight, unsigned framerateCap, bool show);
